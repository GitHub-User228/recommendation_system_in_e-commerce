...
This system works with the data from [ecommerce-dataset](https://www.kaggle.com/datasets/retailrocket/ecommerce-dataset).

Check out the [README.md](/experiments/README.md) to see info about the task and how the recommendation model was built.
